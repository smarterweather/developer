...
| [Error model](./errors.md) | RFC 9457 problem details and the `next_steps` extension across all surfaces | GA |
| [Quickstart](./quickstart.md) | Three requests, no install; then the MCP path | GA |
